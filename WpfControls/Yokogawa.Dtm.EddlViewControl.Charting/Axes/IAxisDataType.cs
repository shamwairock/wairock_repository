...
{
    public interface IAxisDataType
    {
        double ToAxisDouble(object value);
        object ToDataValue(double value);
        double DataLengthToDoubleAxisLength(object value);
        int Compare(object valueOne, object valueTwo);
        bool ValidData(object value);
    }
